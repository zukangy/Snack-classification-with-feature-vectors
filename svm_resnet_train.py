...
test_features = [img for img, _ in test_imgs]
...
test_features = get_embeddings(test_features, gpu=DEVICE, data='test')
...
if grid_search:
    ...
    plt.title('Resnet_50 Embedding Confusion Matrix Heatmap')
